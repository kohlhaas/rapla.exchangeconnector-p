...
public class ExportExchangeDescriptionAnnotationEdit extends RaplaGUIComponent implements AnnotationEditExtension {
    protected String annotationName = DynamicTypeAnnotations.KEY_NAME_FORMAT_EXCHANGE;
    protected String DEFAULT_VALUE = "";
    
    public ExportExchangeDescriptionAnnotationEdit(RaplaContext context) {
        super(context);
    }
